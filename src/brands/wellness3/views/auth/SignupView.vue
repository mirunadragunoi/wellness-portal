<template>
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div class="auth-info">
        <div class="auth-info__step">
          <span class="auth-info__num">1</span>
          <p>{{ t('auth.signup_step1') }}</p>
        </div>
        <div class="auth-info__step">
          <span class="auth-info__num">2</span>
          <p>{{ t('auth.signup_step2') }}</p>
        </div>
        <div class="auth-info__step">
          <span class="auth-info__num">3</span>
          <p>{{ t('auth.signup_step3') }}</p>
        </div>
      </div>
...
.auth-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(14,165,233,0.4); }
...
.auth-info { display: flex; flex-direction: column; gap: 14px; margin-bottom: 28px; }
.auth-info__step { display: flex; align-items: flex-start; gap: 12px; }
.auth-info__num {
...
.auth-info__step p { font-size: 14px; color: var(--text-secondary); line-height: 1.5; padding-top: 3px; }
</style>
